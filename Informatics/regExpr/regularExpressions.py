...
print("Введите целое шестизначное число (табельный номер студента, логин ИСУ) или свой смайлик. С помощью регулярных выражений, программа сделает из него смайлик!")
var1 = input()
try:
    var1 = int(var1)
...
print(len(re.findall(re.escape(pattern1), text)))
