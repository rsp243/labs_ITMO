...
public class Insert extends Command {
    ...
    public String execute(CollectionWorker worker, String nameOfCommand, ArrayList<String> extraArguments) {
        // extraArguments should be ArrayList<String> = [keyOfCity, nameOfCity, strCoordinatesData, ...
        // ... srtArea, strPopulation, strMetersAboveSeaLevel, strTelephoneCode, strCarCode, strClimate, strGovernor]
        ...
        System.out.println(nameOfCity + strCoordinatesData + srtArea + strPopulation + strMetersAboveSeaLevel + strTelephoneCode + strCarCode + strClimate + strGovernor);

        // City newCity = new City(worker.getAutoIncrementedKey(), , null, null, null, 0, 0, 0, null, null)
